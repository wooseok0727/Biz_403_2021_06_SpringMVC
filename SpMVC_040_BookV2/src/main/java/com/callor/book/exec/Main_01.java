...
import com.callor.book.model.BookDTO.BookDTOBuilder;
...
public class Main_01 {
	...
	public static void main(String[] args) {
		...
		BookDTO bookDTO1 = new BookDTO(
				"자바스크립트","link","image","author","price",
		...
		// new 라는 키워드로 생성자를 호출하지 않는다
		// 필요한 변수(속성, 멤버변수)만 가지고 있는 객체를 만들 수 있다
		// 변수이름을 직접 호출하는 방식으로 값을 저장할 수 있다
		BookDTO bookDTO2 = BookDTO.builder().title("자바스크립").price("20000").isbn("9760000").build();
